      ...
      <div className=" hidden lg:block bg-[#DEF1F5]">
          ...
          <section className=" pt-5">
            <div className="  flex gap-4 mx-auto items-center justify-center ">
              <div className=" relative flex  w-[50%] gap-6  justify-center items-center  ">
                <input
                  type="text"
                  className=" pl-9 w-full border-[.2px] py-3 rounded-xl "
                />
                <RiSearch2Line
                  size={20}
                  className=" font-thin top-0 m-auto h-full  left-2 absolute"
                />
        ...
        <section className=" flex text-white mt-3  px-[10em] justify-center w-full  bg-[#2FDF36] ">
          ...
          <div className="  font-bold text-center flex flex-col">
            ...
            <p className=" text-[1.2em] font-mono">
              Enhance your information <br /> retention and access knowledge
            </p>
          </div>
        </section>
        ...
        <section className="  px-[10em] pt-5">
          <h1 className="font-[600] mb-[3em] text-center   ">
            Course Categories
          </h1>
          <div className=" grid grid-cols-3  gap-[6em] items-center justify-center  ">
            <div
              onClick={() => selectCourse("physics")}
              className=" relative w-full bg-white h-[20em]    shadow-lg    rounded-3xl "
            >
            ...
            <div
              onClick={() => selectCourse("chemistry")}
              className=" relative w-full bg-white h-[20em]    shadow-lg    rounded-3xl "
            >
              <div className=" absolute w-full flex justify-center items-center  top-[-10%] ">
            ...
            <div
              onClick={() => selectCourse("geography")}
              className=" relative w-full bg-white h-[20em]    shadow-lg    rounded-3xl "
            >
              <div className=" absolute w-full flex justify-center items-center  top-[-10%] ">
      ...
      <div className=" block lg:hidden bg-[#DEF1F5] px-[1em] pt-4 pb-[9em] w-full ">
        ...
        <section className=" pt-5">
          <div className=" flex gap-4 items-center justify-center ">
            <input
              type="text"
              className=" w-full border-[.2px] p-3 rounded-xl "
            />
        ...
        <section className=" pt-5">
          ...
          <div className=" grid grid-cols-2  mt-5 pt-5 gap-[4em] items-center justify-center  ">
            <div
              onClick={() => selectCourse("biology")}
              className=" relative w-full bg-white h-[120px]    shadow-lg  rounded-md  "
            >
        ...
        <section className=" pt-5">
          ...
          <div className="  flex overflow-x-scroll gap-4">
            ...
            <div>
              <img
                src={CourseImg}
                className="  cursor-pointer max-w-[10em] "
                alt=""
              />
              <p>javascript</p>
              <h1 className="font-[300] mb-[3em]  ">Programming</h1>
        ...
        <section className=" relative w-full pt-5">
          <div className="w-full ">
            <img
              src={OngoingImg}
              className=" h-full bg-red-300   rounded-xl cursor-pointer  filter  w-full object-cover "
              alt=""
            />
            <div className=" absolute top-[0%] left-2 p-3 w-[30%] text-white">
              <h1 className="  text-[1.2em] py-4  ">Ongoing</h1>
              <h1 className="font-bold text-[1.2em]  mb-[1em]  ">
                Study of Algorithms
              </h1>
              <button className=" font-bold text-[1.2em]  bg-white text-black p-2 rounded-full">
                Continue
              </button>
            </div>
          </div>
